        ...
        extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient
{
    ...
    public class Owner
    {
        ...
        public class Email
                extends PublisherRequest<biz.turnonline.ecosystem.publisher.model.EmailId>
        {
            ...
            {
                super( Publisher.this, "POST", REST_PATH, content, biz.turnonline.ecosystem.publisher.model.EmailId.class );
                this.loginId = com.google.api.client.util.Preconditions.checkNotNull( loginId, "Required parameter loginId must be specified." );
                this.name = com.google.api.client.util.Preconditions.checkNotNull( name, "Required parameter name must be specified." );
            }

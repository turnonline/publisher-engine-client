...
/**
 * Model definition for EmailPayloadRecipients.
 *
...
public final class EmailPayloadRecipients
        extends com.google.api.client.json.GenericJson
{
     ...
     */
    public EmailPayloadRecipients setBcc( java.util.List<EmailRecipient> bcc )
    {
        this.bcc = bcc;
        return this;
    }
     ...
     */
    public EmailPayloadRecipients setCc( java.util.List<EmailRecipient> cc )
    {
        this.cc = cc;
        return this;
    }
     ...
     */
    public EmailPayloadRecipients setTo( java.util.List<EmailRecipient> to )
    {
        this.to = to;
        return this;
    }
    ...
    @Override
    public EmailPayloadRecipients set( String fieldName, Object value )
    {
        return ( EmailPayloadRecipients ) super.set( fieldName, value );
    }

    @Override
    public EmailPayloadRecipients clone()
    {
        return ( EmailPayloadRecipients ) super.clone();
    }

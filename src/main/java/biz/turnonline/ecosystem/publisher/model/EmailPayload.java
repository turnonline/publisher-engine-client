        ...
        extends com.google.api.client.json.GenericJson
{
     ...
     */
    @com.google.api.client.util.Key
    private EmailPayloadFrom from;

    /**
     * The value may be {@code null}.
     */
    @com.google.api.client.util.Key
    private EmailPayloadRecipients recipients;

    /**
     * The value may be {@code null}.
     */
    @com.google.api.client.util.Key
    private EmailPayloadReplyTo replyTo;
     ...
     * @return value or {@code null} for none
     */
    public EmailPayloadFrom getFrom()
    {
        return from;
    }
     ...
     */
    public EmailPayload setFrom( EmailPayloadFrom from )
    {
        this.from = from;
        return this;
    }
     ...
     * @return value or {@code null} for none
     */
    public EmailPayloadRecipients getRecipients()
    {
        return recipients;
    }
     ...
     */
    public EmailPayload setRecipients( EmailPayloadRecipients recipients )
    {
     ...
     * @return value or {@code null} for none
     */
    public EmailPayloadReplyTo getReplyTo()
    {
        return replyTo;
    }
     ...
     */
    public EmailPayload setReplyTo( EmailPayloadReplyTo replyTo )
    {
